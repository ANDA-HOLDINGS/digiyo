  ...
  return (
    <>
      ...
      >
        ...
        >
          {userTokens !== null ? <AllScreenTabs /> : <AuthScreens />}
        </NavigationContainer>
      </ThemeContext.Provider>
    </>
  );
...
function AuthScreens() {
  ...
  return (
    <ScreenTabs.Navigator
      initialRouteName={userTokens ? "HomeScreen" : "LoginScreen"}
    ...
    >
      ...
      <ScreenTabs.Screen
        name="joinFoundersPaymentScreen"
        component={JoinFoundersPaymentScreen}
      />
      <ScreenTabs.Screen
...
function AllScreenTabs() {
  return (
    ...
    >
      ...
      />
      <ScreenTabs.Screen name="blockListScreen" component={BlockListScreen} />
    </ScreenTabs.Navigator>
  );
}
